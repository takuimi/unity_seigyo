...
public class ButtonManager_s0_1 : MonoBehaviour
{
    ...
    {
        Debug.Log("Menu_0_1 に戻ります");
        SceneManager.LoadScene("Menu_0_1");
    }

    public void NextButton()
    {
        Debug.Log("Menu_0_2 に進みます");
        SceneManager.LoadScene("Menu_0_2");
    }
}
